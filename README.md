...
This release branch adds Ohlson and Zmijewski company-distress scores plus
portfolio drawdown, downside deviation, historical VaR/CVaR, recovery, Ulcer
Index, worst-period, and rolling Sharpe/Sortino analytics. It reuses normalized
financial statements and existing price history, and returns an explicit
unavailable state when observations are insufficient.
