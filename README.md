...
This major-version branch contains V2.2 factor research plus Pro institutional
portfolio analytics: selectable benchmarks, advanced Monte Carlo models,
exposure and concentration analysis, risk budgets, stress scenarios, factor and
return attribution, rebalancing suggestions, income estimates, and simplified
tax views. Basic users retain the regular two-year simulation; advanced output
is gated by the existing plan flag.
