...
_MODELS = (
    ...
    ("beneish", "accounting", "understand", "low"),
    ("dechow", "accounting", "understand", "low"),
    ("accounting_quality", "accounting", "understand", "low"),
    ("fraud_dashboard", "accounting", "investigate", "low"),
