...
from codes.models import (
    ...
    options_signal_engine as options_signal_model,
)
...
def _refresh_cached_options_signal(result: dict) -> dict:
    """Refresh only the short-lived options overlay on cached fundamentals."""
    ...
    try:
        ...
        print(f"Cached option signal refresh failed for {symbol}: {type(exc).__name__}: {exc}")
    return result
