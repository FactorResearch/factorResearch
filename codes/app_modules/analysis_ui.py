...
def _build_analysis_content(data: dict) -> list:
    ...
    accounting_children = [
        ...
        html.Div(className="analysis-card-grid analysis-card-grid--two", children=[fcf_quality_card, accounting_quality_card]),
        html.Div(className="analysis-card-grid analysis-card-grid--two", children=[beneish_card, dechow_card]),
        fraud_dashboard_card,
    ]
