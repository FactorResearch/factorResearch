...
from codes.app_modules.tabs import analyze, factor_lab, navigation, portfolio, screener as screener_tab  # noqa: F401
...
app.index_string = app.index_string.replace(
    '</head>',
    '<script>'
    'const APP_VERSION = "v3.2";'  # bump this on each deploy
