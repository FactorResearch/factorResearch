...
*{{box-sizing:border-box}}body{{margin:0;background:var(--bg);color:var(--text);font:14px/1.55 Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}}a{{color:inherit}}.topbar{{height:64px;border-bottom:1px solid #1e2a3a;display:flex;align-items:center;justify-content:space-between;padding:0 max(20px,calc((100vw - 1360px)/2));background:rgba(13,17,23,.96)}}.brand{{display:flex;align-items:center;gap:10px;font-weight:800;font-size:17px;text-decoration:none}}.brand-mark{{width:32px;height:32px;border-radius:7px;display:grid;place-items:center;background:rgba(22,119,255,.14);color:#448aff}}.topnav{{display:flex;gap:6px;padding:4px;background:#161d2a;border:1px solid #1e2a3a;border-radius:8px}}.topnav a{{padding:7px 13px;color:var(--dim);text-decoration:none;border-radius:6px;font-size:13px}}.topnav a.active{{background:#1677ff;color:white}}main{{max-width:1360px;margin:auto;padding:24px 20px 64px}}.hero{{position:relative;overflow:hidden;min-height:260px;padding:34px;border:1px solid color-mix(in srgb,var(--accent) 38%,#29384b);border-radius:12px;background:linear-gradient(120deg,#161d2a 0%,#121a26 62%,color-mix(in srgb,var(--accent) 13%,#121a26));display:flex;align-items:flex-end}}.hero:before,.hero:after{{content:"";position:absolute;border:1px solid color-mix(in srgb,var(--accent) 32%,transparent);border-radius:50%;pointer-events:none}}.hero:before{{width:360px;height:360px;right:-80px;top:-190px;box-shadow:0 0 90px color-mix(in srgb,var(--accent) 18%,transparent)}}.hero:after{{width:210px;height:210px;right:155px;bottom:-145px;border-color:color-mix(in srgb,var(--accent-2) 35%,transparent)}}.hero-content{{position:relative;z-index:1;display:flex;align-items:center;gap:24px}}.monogram{{width:96px;height:96px;display:grid;place-items:center;border-radius:24px;background:linear-gradient(145deg,var(--accent),var(--accent-2));color:white;font-size:31px;font-weight:800;letter-spacing:-.04em;box-shadow:0 16px 40px color-mix(in srgb,var(--accent) 24%,transparent)}}.eyebrow,.official-kicker{{font:600 10px/1.4 "DM Mono",monospace;letter-spacing:.12em;text-transform:uppercase;color:var(--accent)}}h1{{font-size:36px;line-height:1.12;margin:7px 0 8px;letter-spacing:-.03em}}.hero p{{max-width:720px;color:var(--dim);margin:0}}.hero-meta{{display:flex;gap:8px;margin-top:16px;flex-wrap:wrap}}.hero-meta span,.hero-meta a{{border:1px solid #304158;background:rgba(13,17,23,.55);border-radius:999px;padding:5px 10px;color:#b8c4d2;text-decoration:none;font-size:12px}}.columns{{display:grid;grid-template-columns:minmax(0,1.65fr) minmax(320px,.85fr);gap:20px;margin-top:20px}}.section-shell,.upgrade{{background:var(--surface);border:1px solid #1e2a3a;border-radius:10px;padding:20px}}.section-title{{display:flex;justify-content:space-between;align-items:end;border-bottom:1px solid #263447;padding-bottom:14px;margin-bottom:14px}}h2{{font-size:17px;margin:0}}.section-title p{{margin:2px 0 0;color:var(--dim);font-size:12px}}.history-card{{background:var(--card);border:1px solid var(--border);border-left:3px solid var(--accent);border-radius:8px;padding:16px;margin:12px 0;transition:.18s ease}}.history-card:hover{{transform:translateY(-1px);border-color:color-mix(in srgb,var(--accent) 60%,#29384b)}}.history-card-head{{display:flex;justify-content:space-between;gap:12px}}time{{display:block;color:var(--dim);font:500 11px "DM Mono",monospace;margin-top:3px}}.score-chip{{font:600 13px "DM Mono",monospace;color:var(--green);background:rgba(0,230,118,.1);border:1px solid rgba(0,230,118,.2);border-radius:999px;padding:5px 9px;height:max-content}}.history-card h3{{font-size:18px;margin:12px 0 4px}}.history-card p{{color:var(--dim);font-size:12px}}.warning-row{{display:flex;gap:6px;flex-wrap:wrap;margin:8px 0}}.warning-row span{{border-radius:999px;padding:3px 8px;font-size:10px;font-weight:700}}.warning-chip{{background:rgba(255,171,0,.1);color:var(--amber)}}.positive-chip{{background:rgba(0,230,118,.1);color:var(--green)}}.danger-chip{{background:rgba(255,23,68,.1);color:var(--red)}}.history-card>a{{display:inline-block;color:#69a7ff;font-weight:650;text-decoration:none;margin-top:12px}}.mini-grid{{display:grid;grid-template-columns:repeat(3,1fr);gap:1px;background:#2a394c;border:1px solid #2a394c;border-radius:6px;overflow:hidden;margin-top:12px}}.mini-grid span{{background:#172231;padding:8px;color:#aebccc;font:500 10px "DM Mono",monospace}}.private{{border-left-color:var(--accent-2)}}.upgrade{{border-style:dashed;color:var(--dim)}}.upgrade h2{{color:var(--text);margin-bottom:8px}}.tabs{{display:none}}nav[aria-label="History pages"] a{{display:inline-block;margin-top:12px;color:#69a7ff}}.footer{{max-width:1360px;margin:auto;padding:20px;border-top:1px solid #1e2a3a;color:#526173;font-size:11px}}
.hero[data-motif="network"]{{background-color:#111827;background-image:radial-gradient(circle at 78% 28%,color-mix(in srgb,var(--accent) 85%,transparent) 0 3px,transparent 4px),radial-gradient(circle at 88% 64%,color-mix(in srgb,var(--accent-2) 80%,transparent) 0 5px,transparent 6px),radial-gradient(circle at 66% 74%,color-mix(in srgb,var(--accent) 60%,transparent) 0 4px,transparent 5px),linear-gradient(128deg,#151d2a 38%,color-mix(in srgb,var(--accent) 18%,#101722))}}.hero[data-motif="network"]:before{{width:280px;height:160px;right:7%;top:44px;border-radius:50%;transform:rotate(-18deg);box-shadow:none}}.hero[data-motif="network"]:after{{width:190px;height:110px;right:18%;bottom:20px;border-radius:50%;transform:rotate(25deg)}}.hero[data-motif="network"] .monogram{{border-radius:50% 50% 42% 58%/58% 43% 57% 42%}}body:has(.hero[data-motif="network"]) .history-card{{border-left:0;border-top:2px solid var(--accent)}}
.hero[data-motif="compute"]{{border-radius:4px;background-color:#101610;background-image:linear-gradient(color-mix(in srgb,var(--accent) 13%,transparent) 1px,transparent 1px),linear-gradient(90deg,color-mix(in srgb,var(--accent) 13%,transparent) 1px,transparent 1px),linear-gradient(130deg,#101610,#172415);background-size:24px 24px,24px 24px,auto}}.hero[data-motif="compute"]:before{{border-radius:0;width:220px;height:220px;right:8%;top:20px;transform:rotate(45deg)}}.hero[data-motif="compute"] .monogram{{border-radius:4px;clip-path:polygon(12% 0,100% 0,100% 88%,88% 100%,0 100%,0 12%)}}body:has(.hero[data-motif="compute"]) .section-shell,body:has(.hero[data-motif="compute"]) .history-card{{border-radius:3px}}body:has(.hero[data-motif="compute"]) .mini-grid{{grid-template-columns:repeat(4,1fr)}}
.hero[data-motif="precision"]{{min-height:320px;align-items:center;background:linear-gradient(155deg,#1b2027,#11151b 68%);border-color:#3a424d}}.hero[data-motif="precision"]:before{{width:1px;height:100%;right:24%;top:0;border:0;background:linear-gradient(transparent,var(--accent),transparent);border-radius:0}}.hero[data-motif="precision"]:after{{display:none}}.hero[data-motif="precision"] .monogram{{border-radius:28px;background:linear-gradient(145deg,#d7dce2,#8994a1);color:#111820;box-shadow:0 20px 70px rgba(255,255,255,.08)}}body:has(.hero[data-motif="precision"]) .columns{{gap:32px;margin-top:32px}}body:has(.hero[data-motif="precision"]) .history-card{{padding:22px;border-left:1px solid var(--border)}}
.hero[data-motif="consumer"]{{min-height:290px;border-radius:28px;background:radial-gradient(ellipse at 90% 110%,color-mix(in srgb,var(--accent) 55%,transparent) 0 34%,transparent 35%),radial-gradient(ellipse at 78% 105%,color-mix(in srgb,var(--accent-2) 35%,transparent) 0 43%,transparent 44%),linear-gradient(120deg,#211519,#17151b)}}.hero[data-motif="consumer"]:before{{width:470px;height:120px;right:-80px;top:20px;transform:rotate(-8deg)}}.hero[data-motif="consumer"] .monogram{{border-radius:50%}}body:has(.hero[data-motif="consumer"]) h1,body:has(.hero[data-motif="consumer"]) .history-card h3{{font-family:Georgia,serif;font-weight:600}}body:has(.hero[data-motif="consumer"]) .history-card,body:has(.hero[data-motif="consumer"]) .section-shell{{border-radius:18px}}
.hero[data-motif="finance"]{{border-radius:2px;background-image:repeating-linear-gradient(90deg,transparent 0 79px,color-mix(in srgb,var(--accent) 11%,transparent) 80px),linear-gradient(145deg,#111c29,#16263a)}}.hero[data-motif="finance"]:before{{width:42%;height:70%;right:5%;top:15%;border:0;border-radius:0;background:repeating-linear-gradient(90deg,color-mix(in srgb,var(--accent) 30%,transparent) 0 2px,transparent 2px 34px)}}.hero[data-motif="finance"] .monogram{{border-radius:3px}}body:has(.hero[data-motif="finance"]) .history-card{{border-radius:2px;border-left-width:5px}}body:has(.hero[data-motif="finance"]) .mini-grid{{border-radius:0}}
.hero[data-motif="mobility"]{{border-radius:6px;background:repeating-linear-gradient(118deg,transparent 0 52px,color-mix(in srgb,var(--accent) 10%,transparent) 53px 55px),linear-gradient(120deg,#19171a,#201216)}}.hero[data-motif="mobility"]:before{{width:520px;height:3px;right:-40px;top:44%;border:0;border-radius:0;background:linear-gradient(90deg,transparent,var(--accent),var(--accent-2));transform:rotate(-12deg);box-shadow:0 45px 0 color-mix(in srgb,var(--accent) 24%,transparent)}}.hero[data-motif="mobility"]:after{{display:none}}.hero[data-motif="mobility"] .monogram{{border-radius:2px;transform:skew(-5deg)}}body:has(.hero[data-motif="mobility"]) .history-card{{clip-path:polygon(0 0,calc(100% - 12px) 0,100% 12px,100% 100%,0 100%)}}
.hero[data-motif="platform"]{{background-color:#111a25;background-image:linear-gradient(30deg,color-mix(in srgb,var(--accent) 12%,transparent) 12%,transparent 12.5%,transparent 87%,color-mix(in srgb,var(--accent-2) 12%,transparent) 87.5%),linear-gradient(150deg,color-mix(in srgb,var(--accent-2) 10%,transparent) 12%,transparent 12.5%,transparent 87%,color-mix(in srgb,var(--accent) 10%,transparent) 87.5%);background-size:72px 126px}}.hero[data-motif="platform"]:before{{border-radius:20px;transform:rotate(12deg)}}.hero[data-motif="platform"] .monogram{{border-radius:18px 4px 18px 4px}}body:has(.hero[data-motif="platform"]) .history-card:nth-of-type(even){{border-left-color:var(--accent-2)}}
html.light{{--bg:#fff;--surface:#f8fafc;--card:#fff;--border:#cbd5e1;--text:#0f172a;--dim:#475569;--green:#087f3f;--red:#c62828;--amber:#946200}}html.light body{{background:var(--bg);color:var(--text)}}html.light .topbar{{background:rgba(255,255,255,.96);border-bottom-color:var(--border)}}html.light .brand-mark{{background:#e8f1ff;color:#075fc7}}html.light .topnav{{background:#f1f5f9;border-color:var(--border)}}html.light .topnav a{{color:#475569}}html.light .topnav a.active{{background:#075fc7;color:#fff}}html.light .hero{{background-color:#f8fafc;background-image:linear-gradient(125deg,#fff 25%,#f1f5f9 68%,color-mix(in srgb,var(--accent) 13%,#fff));border-color:color-mix(in srgb,var(--accent) 45%,var(--border));box-shadow:0 12px 30px rgba(15,23,42,.06)}}html.light .hero p{{color:#475569}}html.light .hero-meta span,html.light .hero-meta a{{background:rgba(255,255,255,.8);border-color:var(--border);color:#334155}}html.light .section-shell,html.light .upgrade,html.light .history-card{{background:#fff;border-color:var(--border);box-shadow:0 5px 16px rgba(15,23,42,.04)}}html.light .section-title{{border-bottom-color:var(--border)}}html.light .history-card p,html.light time{{color:#475569}}html.light .mini-grid{{background:var(--border);border-color:var(--border)}}html.light .mini-grid span{{background:#f8fafc;color:#334155}}html.light .footer{{border-top-color:var(--border);color:#64748b}}html.light .score-chip{{color:#087f3f;background:rgba(8,127,63,.08);border-color:rgba(8,127,63,.22)}}html.light .history-card>a,html.light nav[aria-label="History pages"] a{{color:#075fc7}}html.light .hero[data-motif="network"]{{background-image:radial-gradient(circle at 78% 28%,color-mix(in srgb,var(--accent) 72%,transparent) 0 3px,transparent 4px),radial-gradient(circle at 88% 64%,color-mix(in srgb,var(--accent-2) 65%,transparent) 0 5px,transparent 6px),linear-gradient(128deg,#fff 38%,color-mix(in srgb,var(--accent) 11%,#f8fafc))}}html.light .hero[data-motif="compute"]{{background-image:linear-gradient(color-mix(in srgb,var(--accent) 15%,transparent) 1px,transparent 1px),linear-gradient(90deg,color-mix(in srgb,var(--accent) 15%,transparent) 1px,transparent 1px),linear-gradient(130deg,#fff,#f0f7ed);background-size:24px 24px,24px 24px,auto}}html.light .hero[data-motif="consumer"]{{background-image:radial-gradient(ellipse at 90% 110%,color-mix(in srgb,var(--accent) 24%,transparent) 0 34%,transparent 35%),radial-gradient(ellipse at 78% 105%,color-mix(in srgb,var(--accent-2) 18%,transparent) 0 43%,transparent 44%),linear-gradient(120deg,#fff,#fff7f7)}}html.light .hero[data-motif="finance"]{{background-image:repeating-linear-gradient(90deg,transparent 0 79px,color-mix(in srgb,var(--accent) 12%,transparent) 80px),linear-gradient(145deg,#fff,#eef5fb)}}html.light .hero[data-motif="mobility"]{{background-image:repeating-linear-gradient(118deg,transparent 0 52px,color-mix(in srgb,var(--accent) 12%,transparent) 53px 55px),linear-gradient(120deg,#fff,#fff4f4)}}html.light .hero[data-motif="platform"]{{background-color:#f8fafc;background-image:linear-gradient(30deg,color-mix(in srgb,var(--accent) 10%,transparent) 12%,transparent 12.5%,transparent 87%,color-mix(in srgb,var(--accent-2) 10%,transparent) 87.5%),linear-gradient(150deg,color-mix(in srgb,var(--accent-2) 8%,transparent) 12%,transparent 12.5%,transparent 87%,color-mix(in srgb,var(--accent) 8%,transparent) 87.5%)}}
@media(max-width:760px){{.topnav{{display:none}}main{{padding:14px 12px 40px}}.hero{{min-height:310px;padding:24px}}.hero-content{{align-items:flex-start;flex-direction:column}}.monogram{{width:72px;height:72px;border-radius:18px}}h1{{font-size:29px}}.columns{{display:block}}.columns>section,.columns>div{{margin-bottom:14px}}.tabs{{display:block;color:var(--dim);font-size:12px;margin:14px 2px}}.mini-grid{{grid-template-columns:repeat(2,1fr)!important}}}}
</style></head>
