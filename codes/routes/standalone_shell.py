...
def header(active: str = "") -> str:
    ...
    return f"""<header class="topbar"><a class="topbar-brand" href="/"><img src="/assets/logo.svg" alt="FactorResearch" class="topbar-logo"><span class="topbar-title">FactorResearch</span></a>
